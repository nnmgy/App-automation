...
import PcServices.GetEnvironmentVariable;
...
{   public static  AndroidDriver driver ;
    ...
    public void beforeClass() throws MalformedURLException, InterruptedException {
        ...
        GetEnvironmentVariable DriverData   =new GetEnvironmentVariable();
        ...
        capabilities.setCapability("platformVersion", DriverData.DevicesVersion());  
